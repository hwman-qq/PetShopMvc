...
namespace PetShop.SQLServerDAL {
	...
	public class ProfileDAO : IProfileDO{
	...
	private const string SQL_SELECT_BANNERDATA = "Select BannerData from BannerData where FavCategory = @FavCategory";
		...
		public string GetBannerPath(string FavCategory) {
			...
			BannerPath = Convert.ToString(SQLHelper.ExecuteScalar(SQLHelper.CONN_STRING_NON_DTC, CommandType.Text, SQL_SELECT_BANNERDATA, parm));			
